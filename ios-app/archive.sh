#!/bin/bash
# Color Split — Archive & export for App Store Connect.
#
...
#   ./archive.sh <TEAM_ID>
#
# This produces build/ColorSplit.ipa, ready to upload with Transporter
...
ARCHIVE_PATH="build/ColorSplit.xcarchive"
EXPORT_DIR="build/export"

echo "▸ Archiving…"
xcodebuild -project ColorSplit.xcodeproj \
  -scheme ColorSplit \
